                    ...
                    <>
                        <div className="bg-white">
                            <div className="px-6 py-4 sm:px-6 sm:py-32 lg:px-8">
                                ...
                                <p className="mx-auto mt-6 max-w-xl text-lg leading-6 text-gray-600">
                                ...
                                <p className="mx-auto mt-6 max-w-xl text-lg leading-6 text-gray-600">
                                    <b>Galería</b> es un recorrido por las distintas explicaciones de los elementos que llegaron a inspirar estas obras y un reconocimiento a los protagonistas de los avances en la inmunohematología universal y mexicana.
                                </p>
                                <p className="mx-auto mt-6 max-w-xl text-lg leading-6 text-gray-600">
